...
public class PagRequestActivity extends AppCompatActivity {
    ...
    public class PagRequestWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if(url.contains("www.google.com")) {
                PagSeguroAuthorization authorization = new PagSeguroAuthorization(PagRequestActivity.this);
                // confirmation
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            // show loading error
            Toast.makeText(PagRequestActivity.this, "Oh no! " + description, Toast.LENGTH_LONG).show();
