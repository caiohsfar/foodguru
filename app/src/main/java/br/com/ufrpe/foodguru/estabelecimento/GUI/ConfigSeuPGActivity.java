...
public class ConfigSeuPGActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PagSeguroRequest pagSeguroRequest = new PagSeguroRequest(ConfigSeuPGActivity.this);
    ...
    private void abrirHomeEstabelecimento() {
        Intent intent = new Intent(ConfigSeuPGActivity.this, HomeEstabelecimentoActivity.class);
