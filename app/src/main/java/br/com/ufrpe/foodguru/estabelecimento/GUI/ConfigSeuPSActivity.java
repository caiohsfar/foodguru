...
public class ConfigSeuPSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PagSeguroRequest pagSeguroRequest = new PagSeguroRequest(ConfigSeuPSActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_CANCELED) {
            ...
            if(requestCode==PagSeguroRequest.PAG_SEGURO_REQUEST_CODE){
                ...
                final String msg = "Autorização cancelada";
            ...
            switch (data.getIntExtra(PagSeguroRequest.PAG_SEGURO_EXTRA, 0)){
                ...
                case PagSeguroRequest.PAG_SEGURO_REQUEST_FAILURE_CODE:{
                    final String msg = "A tentativa de autorização falhou.";
                    PagSeguroUtil.showConfirmDialog(this,msg,null);
                    break;
                }
    ...
    private void abrirHomeEstabelecimento() {
        Intent intent = new Intent(ConfigSeuPSActivity.this, HomeEstabelecimentoActivity.class);
