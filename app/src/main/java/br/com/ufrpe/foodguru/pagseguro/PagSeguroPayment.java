...
public class PagSeguroPayment {
    ...
    //substituir para o modelo de aplicações!!!

    public void pay(String checkoutXml, String authorizationCode) {
        if (authorizationCode == null){
            Log.d("PAG", "authCodeNull" + authorizationCode);
            return;
        }
        ...
        //não precisamos usar token mais :)
        ...
        final String pagseguroWsRequestAddress = String.format(webService, appId, appKey, authorizationCode);
