...
public class PagSeguroCheckout {
     ...
     * Only with basic informations. Without buyer and shipping informations. By Caio*
     ...
     */
    public PagSeguroCheckout(@NonNull final String saleReference
            , @NonNull final PagSeguroCurrency landCurrency
            , @NonNull final List<PagSeguroItem> boughtItems)
    {
    ...
    public PagSeguroCheckout(@NonNull final String saleReference
            , @NonNull final PagSeguroCurrency landCurrency
            , @NonNull final List<PagSeguroItem> boughtItems
            , @NonNull final PagSeguroBuyer pagSeguroBuyer
            , @NonNull final PagSeguroShipping pagSeguroShipping)
    {
        this(saleReference, landCurrency, boughtItems);
    ...
    //só funciona se só tiver as info basicas (sem buyer e shipping);
    ...
    private String buildPagSeguroItemsXml(){
        ...
        for (PagSeguroItem item: boughtItems) {
            itemXml.append(item.buildPagSeguroItemXml());
        }
