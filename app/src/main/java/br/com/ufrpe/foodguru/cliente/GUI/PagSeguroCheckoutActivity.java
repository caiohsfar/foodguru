...
public class PagSeguroCheckoutActivity extends AppCompatActivity {
    ...
    public class PagSeguroWebViewClient extends WebViewClient{
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            // show loading error
            Toast.makeText(PagSeguroCheckoutActivity.this, "Oh no! " + description, Toast.LENGTH_LONG).show();
